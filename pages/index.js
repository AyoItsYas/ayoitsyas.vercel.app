    ...
    return (
        <>
            <Head>
                ...
                />
                <meta name="google-site-verification" content="dbfHPoHZg9kxN2xrs3_bw6DOWKsM8wc0SGqxQ8FBcfw" />
            </Head>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>Python</td>
                                <td>
                                    This is the language I've used the most. I
                                    have been coding discord bots, general
                                    computer applications &amp; things to fiddle
                                    around with. I've mostly worked with
                                    discord.py, Django, PyQt, pillow, &amp;
                                    matplotlib. I know how to debug python code,
                                    data classes, python coding standards, how
                                    to make use of OOP & much more.
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    ...
                                    Next.js in the field of web development. I'm
                                    familliar with JSX and how to manipulate the
                                    DOM structure with bare JS.
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    ...
                                    content. In terms of css frameworks I have
                                    expeirence with bootstrap. I know how to use
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    non-relational databases that includes
                            ...
                            <tr>
                                <td>Additional</td>
                                <td>
                                    I work with Visual Studio Code as my main
                                    editor other than that I have used many
                                    tools that includes VIM, Github, Bitbucket,
                                    Jira, Docker, Slack &amp; many more in my
                                    workflow. In terms of operating systems, I
                                    have expeirence with using Windows and
                                    Ubuntu. I can work with remote machines
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    An asyncrounous API wrapper for discords'
                                    API and websocket connections, that is still
                                    under development as part of learning how
                                    asyncrounous code functions.
                                </td>
                            </tr>
                            <tr>
                                <td>Ranked Bot</td>
                                <td>
                                    Developer of "Ranked Bot". The bot is
                                    capable of retrieving aggregated player
                                    statistics, match statistics, managing rank
                                    roles &amp; game replays served by a backend
                                    API. Bot is available for the public in the{" "}
                                    <a
                            ...
                            <tr>
                                ...
                                <td>
                                    A wrapper over threads that provides
                                    extended control. The module supports
                                    pausing, terminating and putting threads to
                                    sleep. The module also provides some
                                    additional tools like Piping data between
                                    threads and a thread pool to keep track of
                                    threads.
                                </td>
                            </tr>
                            <tr>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>Discord bots</td>
                                <td>
                                    Discord is a goood communication platform to
                                    any sort of community. I can get anything
                                    working from a bot that can do simple day to
                                    day tasks on discord, chat moderation or
                                    pretty much any task as long as the platform
                                    supports.
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    application to fullfill your needs. I ensure
                                    you that the final product will look and
                                    function just the way you want it to. I will
                                    revise and rework it till you are 100%
                                    satisfied in accordance with the design.
                                    <hr />
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            informative like websites with one
                                            or two pages with static data to
                                            showcase.
                                        </li>
                                    </ul>
                                    <hr />
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            Recommended for websites showcasing
                                            data that changes over time with
                                            many pages.
                                        </li>
                                    </ul>
                                </td>
                            ...
                            <tr>
                                <td>Scripting</td>
                                <td>
                                    Web Scraping, Data organzing and statistical
                                    representations or generally anything that
                                    can be programmetically solved with
                                    scripting. It can be to reorganize an Excel
                                    sheet or to hack the FBI. I can look in to
                                    it and provide a simple solution that will
                                    get the task done.
                                </td>
                            </tr>
                        </tbody>
